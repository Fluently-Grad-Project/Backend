...
def accept_friend_request(db: Session, receiver_id: int, sender_id: int):
    ...
    friendship1 = Friendship(user_id=receiver_id, friend_id=sender_id, created_at=datetime.utcnow())
    friendship2 = Friendship(user_id=sender_id, friend_id=receiver_id, created_at=datetime.utcnow())
