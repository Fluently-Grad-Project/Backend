...
def upgrade() -> None:
    ...
    op.add_column('matchmaking', sa.Column('languages', sa.ARRAY(sa.String()), nullable=True))
    op.add_column('matchmaking', sa.Column('practice_frequency', sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    op.add_column('matchmaking', sa.Column('age', sa.INTEGER(), autoincrement=False, nullable=True))
